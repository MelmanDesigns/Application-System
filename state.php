            ...
            <div class="row">
                <div class="col">
                    <div class="card-box z-depth-2">
                        <h4 class="header-title mt-0 m-b-30">State Patrol Images</h4>
                        <div class="row">
                            <img class="materialboxed responsive-img" data-caption="Ssn Andreas State Trooper writing up a scene report." src="assets/images/departments/state/state1.png" alt="Civilian Image #1" width="300" height="215">
                            <?php echo '&nbsp' ?>
                ...
                <div class="col">
                    <div class="card-box z-depth-2">
                        <h4 class="header-title mt-0 m-b-30">State Patrol Information</h4>
