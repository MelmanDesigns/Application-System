            ...
            <div class="row">
                <div class="col">
                    <div class="card-box z-depth-2">
                        <h4 class="header-title mt-0 m-b-30">Sheriff's Office Images</h4>
                        <div class="row">
                ...
                <div class="col">
                    <div class="card-box z-depth-2">
                        <h4 class="header-title mt-0 m-b-30">Sheriff's Office Information</h4>
